...
func TestListWorktrees_Integration(t *testing.T) {
	...
	result, err := ListWorktrees(context.Background())
	if err != nil {
...
func TestCreateWorktree_Integration(t *testing.T) {
	// Skip if not in a git repository
	err := CreateWorktree(context.Background(), "/tmp/test-worktree-integration", "main")
	if err != nil {
...
func TestRemoveWorktree_Integration(t *testing.T) {
	// Skip if not in a git repository
	err := RemoveWorktree(context.Background(), "/tmp/test-worktree-integration")
	if err != nil {
...
func TestGetActiveWorktree_Integration(t *testing.T) {
	// Skip if not in a git repository
	result, err := GetActiveWorktree(context.Background())
	if err != nil {

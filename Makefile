.PHONY: build fetch-cbm test quick-test test-race coverage fmt fmt-check vet lint ci clean install run help
...
install: build ## Build and install late-sast to ~/.local/bin
